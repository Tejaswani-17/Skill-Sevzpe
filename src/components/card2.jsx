...
const Card2 = ({
  ...
  return (
    ...
    >
      ...
      <img
        className="h-[147.6px] w-[210px] relative object-contain mq800:flex-1"
        alt=""
        src={illustration}
      />
    </div>
